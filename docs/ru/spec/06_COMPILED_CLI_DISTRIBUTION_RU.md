...
- Поиск установленного runtime использует путь загруженного бинарника, разрешает симлинки и работает при запуске короткого имени через `PATH` из постороннего каталога.
